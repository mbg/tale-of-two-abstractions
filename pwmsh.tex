...
\bibitem{clarke1998ownership} Clarke, D. G., Potter, J. M., Noble, J.: Ownership types for flexible alias protection. ACM SIGPLAN Not. 33, 48--64 (1998)

\bibitem{cook1990inheritance} Cook, W. R., Hill, W., Canning, P. S.: Inheritance is not subtyping. 125--135 (1990)

\bibitem{day2012towards} Day, L. E., Hutton, G.: Towards modular compilers for effects. In: Trends in Functional Programming, 49--64. Springer (2012)
...
\bibitem{jaskelioff2011monatron} Jaskelioff, M.: Monatron: An extensible monad transformer library. Implementation and Application of Functional Languages, 233--248. Springer (2011)
  
\bibitem{jones1995transformers} Jones, M. P.: Functional programming with overloading and higher-order polymorphism. Advanced Functional Programming, 97-?136. Springer (1995)
  
\bibitem{jones2000type} Jones, M. P.: Type classes with functional dependencies. Program. Lang. Syst., 230--244 (2000)
  
\bibitem{OOHaskell} Kiselyov, O., L{\"a}mmel, R.: Haskell's overlooked object system. arXiv preprint cs/0509027 (2005). Draft.

\bibitem{kiselyov2013extensible} Kiselyov, O., Sabry, A., Swords, C.: Extensible effects: an alternative to monad transformers. In: Proceedings of the 2013 ACM SIGPLAN symposium on Haskell,
  59--70. ACM (2013)

\bibitem{loh2006open} L{\"o}h, A., Hinze, R.: Open data types and open functions. In: Proceedings of the 8th ACM SIGPLAN international conference
...
\bibitem{moggi1989abstract} Moggi, E.: An Abstract View of Programming Languages. Communication (1989)

\bibitem{nadathur1988overview} Nadathur, G., Miller, D.: An overview of $\lambda$PROLOG. In: Fifth International Conference Symposium on Logic Programming (1988)

\bibitem{plotkin2009handlers} Plotkin, G., Pretnar, M.: Handlers of algebraic effects. In: Programming Languages and Systems, 80--94. Springer (2009)

\bibitem{schrijvers2011monads} Schrijvers, T., Oliveira, B. C. d.~S.: Monads, zippers and views: virtualizing the monad stack. In: ACM SIGPLAN Notices, volume~46, 32--44. ACM (2011)

\bibitem{shields2001object} Shields, M., Peyton~Jones, S.: Object-oriented style overloading for Haskell. Electronic Notes in Theoretical Computer Science, 89--108 (2001)

\bibitem{Somogyi1996mercury} Somogyi, Z., Henderson, F., Conway, T.: Execution algorithm of mercury, an efficient purely declarative logic programming language. J. Log. Program. 29, 17--64 (1996)

\bibitem{swierstra2008data} Swierstra, W.: Data types {\`a} la carte. Journal of functional programming, 423--436 (2008)

\bibitem{wadler1998expression} Wadler, P. The expression problem. Java-genericity mailing list (1998)
